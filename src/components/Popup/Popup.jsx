...
const Popup = (props) => {
  return <div className="popup-bg" onClick={props.onClick}>
    <div className="popup">
      <Button className="close" onClick={props.onClick}>
        <span>&times;</span>
      </Button>
      <h2>Text</h2>
      <p className="text">It is a long established fact that a reader will be distracted by the readable content of a
